...
extension String {
    ...
    func toGMTDate(withFormat format: String = "yyyy-MM-dd'T'HH:mm:ss.ZZZ")-> Date? {
    ...
    func convertDoubleToCurrency() -> String {
        ...
        return result.replacingOccurrences(of: "$", with: "J$ ")
    }
    ...
    func removeCurrencyDigits() -> String {
        let list1 = self.split{$0 == "."}.map(String.init)
        return list1.first ?? ""
    }
}
